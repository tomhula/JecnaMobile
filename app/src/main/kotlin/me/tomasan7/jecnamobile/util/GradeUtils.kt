...
import me.tomasan7.jecnamobile.grades.VirtualGrade
 ...
 */
fun Subject.calculateAverageWithPredictions(virtualGrades: List<VirtualGrade>): Float?
{
    ...
    virtualGrades.forEach { predicted ->
